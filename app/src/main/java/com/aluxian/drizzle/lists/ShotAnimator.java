 ...
 */
public class ShotAnimator extends RecyclerView.ItemAnimator {
    ...
    public boolean animateAdd(final RecyclerView.ViewHolder holder) {
        ...
        DisplayMetrics dm = holder.itemView.getContext().getResources().getDisplayMetrics();
        float pixels = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 48, dm);
        ViewCompat.setTranslationY(holder.itemView, pixels);
    ...
    /**
     * Check the state of currently pending and running animations. If there are none pending/running, call {@link
     * #dispatchAnimationsFinished()} to notify any listeners.
     */
